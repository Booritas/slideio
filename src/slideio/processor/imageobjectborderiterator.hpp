...
namespace slideio
{
   ...
   public:
      ...
      ImageObjectBorderIterator(ImageObject *object, cv::Mat &tile, const cv::Rect &tileRect, bool begin) : m_object(object),
      ...
      {
         m_end = !m_tile.findNextObjectBorderPoint(m_object,  cv::Point(m_prev), cv::Point(m_current), m_prev, m_current);
         return *this;
      }
