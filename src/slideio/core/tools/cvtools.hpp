...
namespace slideio
{
    ...
    public:
        ...
        static inline DataType fromOpencvType(int type) { return static_cast<DataType>(type); }
        static inline int toOpencvType(DataType dt) { return static_cast<int>(dt); }

        static inline bool isValidDataType(slideio::DataType dt) { return dt <= slideio::DataType::DT_LastValid; }
