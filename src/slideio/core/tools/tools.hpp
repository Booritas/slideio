...
namespace slideio
{
    ...
    public:
        ...
        static void scaleSize(const cv::Size& srcSize, double scaleX, double scaleY, cv::Size& trgSize);
        ...
        static void throwIfPathExists(const std::string& path, const std::string label);
