...
void CVTools::extractSliceFromMultidimMatrix(cv::Mat multidimMat, const std::vector<int>& indices,
...
void CVTools::insertSliceInMultidimMatrix(cv::Mat& multidimMat, const cv::Mat& sliceMat,
                                          const std::vector<int>& indices)
{
    ...
    if (dataPtr1 != dataPtr2) RAISE_RUNTIME_ERROR << "Slice copy: Unexpected memory reallocation";
}
...
#define TONAME(name) std::string(#name)
    ...
    {
    case DataType::DT_Byte:
        return TONAME(DT_Byte);
    case DataType::DT_Int8:
        return TONAME(DT_Int8);
    case DataType::DT_Int16:
        return TONAME(DT_Int16);
    case DataType::DT_Float16:
        return TONAME(DT_Float16);
    case DataType::DT_Int32:
        return TONAME(DT_Int32);
    case DataType::DT_Float32:
        return TONAME(DT_Float32);
    case DataType::DT_Float64:
        return TONAME(DT_Float64);
    case DataType::DT_UInt16:
        return TONAME(DT_UInt16);
    case DataType::DT_Unknown:
        return TONAME(DT_Unknown);
    case DataType::DT_None:
        return TONAME(DT_None);
    }
...
std::string CVTools::compressionToString(Compression compression)
{
    ...
    switch (compression)
    {
    case slideio::Compression::Unknown:
        name = "Unknown";
        break;
    ...
    case slideio::Compression::Jpeg:
        name = "Jpeg";
        break;
    case slideio::Compression::JpegXR:
        name = "JpegXR";
        break;
    case slideio::Compression::Png:
        name = "Png";
        break;
    ...
    case slideio::Compression::JBIG2:
        name = "JBIG2";
        break;
    case slideio::Compression::GIF:
        name = "GIF";
        break;
    case slideio::Compression::BIGGIF:
        name = "BIGGIF";
        break;
    case slideio::Compression::RLE:
        name = "RLE";
        break;
    default:
        name = std::to_string((int)compression);
    }
    return name;
}
