...
namespace slideio
{
    ...
    public:
        ...
        cv::Rect getRect() const override { return m_sceneRect; }
        int getNumChannels() const override { return m_numChannel; }
        slideio::DataType getChannelDataType(int channel) const override { return m_channelDataType; }
