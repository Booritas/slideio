...
namespace slideio
{
    ...
    public:
        ...
        {
            return m_level == other.m_level && m_size.width == other.m_size.width &&
                   m_size.height == other.m_size.height && std::fabs(m_scale - other.m_scale) < 1.e-2 &&
                   std::fabs(m_magnification - other.m_magnification) < 1.e-2 &&
                   m_tileSize.width == other.m_tileSize.width && m_tileSize.height == other.m_tileSize.height;
        }
        ...
        {
            if (m_tileCount < 1) updateTileCount();
            return m_tileCount;
        }
