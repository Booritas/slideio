...
void TransformerTools::computeInflatedRectParams(const cv::Size& sceneSize, const cv::Rect& blockRect,
                                                 int inflationValue, const cv::Size& blockSize,
                                                 cv::Rect& inflatedBlockRect, cv::Size& inflatedSize,
                                                 cv::Point& blockPositionInInflatedRect)
{
    ...
    blockPositionInInflatedRect = cv::Point(std::lround(xScale * (blockRect.x - inflatedBlockRect.x)),
