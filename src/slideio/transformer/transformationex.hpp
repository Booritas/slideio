...
namespace slideio
{
    ...
    {
    public:
        TransformationEx(const TransformationEx& other): Transformation(other), m_type(other.m_type) {}

        TransformationEx(TransformationEx&& other) noexcept: Transformation(std::move(other)), m_type(other.m_type) {}
        ...
        TransformationType getType() const override { return m_type; }
