...
void slideio::ometiff::TiffData::init(const std::string& directoryPath, TIFFFiles* files, Dimensions *dims, tinyxml2::XMLElement* xmlTiffData) {
...
const slideio::TiffDirectory& slideio::ometiff::TiffData::getTiffDirectory(int plane) const {
