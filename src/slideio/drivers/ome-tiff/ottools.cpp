...
DataType OTTools::stringToDataType(const std::string& type)
{
    ...
    std::transform(caseInsensitiveType.begin(), caseInsensitiveType.end(), caseInsensitiveType.begin(),
                   [](unsigned char c) { return std::tolower(c); });
    if (caseInsensitiveType == "int8") return DataType::DT_Int8;
    if (caseInsensitiveType == "uint8") return DataType::DT_Byte;
    if (caseInsensitiveType == "uint16") return DataType::DT_UInt16;
    if (caseInsensitiveType == "uint32") return DataType::DT_UInt32;
    if (caseInsensitiveType == "uint64") return DataType::DT_UInt64;
    if (caseInsensitiveType == "int8") return DataType::DT_Int8;
    if (caseInsensitiveType == "int16") return DataType::DT_Int16;
    if (caseInsensitiveType == "int32") return DataType::DT_Int32;
    if (caseInsensitiveType == "int64") return DataType::DT_Int64;
    if (caseInsensitiveType == "float") return DataType::DT_Float32;
    if (caseInsensitiveType == "double") return DataType::DT_Float64;
