...
std::string vsi::VSIFile::getVolumeName(int32_t tag)
{
    switch (tag)
    {
...
std::string vsi::VSIFile::getTagName(int32_t tag)
{
    switch (tag) {
...
std::string vsi::VSIFile::getDeviceSubtype(const std::string& value)
{
