...
namespace slideio
{
    ...
    public:
        ...
        void init(uint64_t sceneId, SceneParams& sceneParams, const std::string& filePath, int sceneIndex, const CZISubBlocks& blocks, CZISlide* slide, bool mainScene = true);
