...
std::ostream& slideio::operator<<(std::ostream& os, const slideio::DataType& dt)
{
    ...
    case slideio::DataType::DT_UInt16:
        os << "DT_UInt16";
        break;
    case slideio::DataType::DT_Unknown:
        os << "DT_Unknown";
        break;
    case slideio::DataType::DT_None:
        os << "DT_None";
        break;
    default:
        os << (int)dt;
...
std::ostream& slideio::operator<<(std::ostream& os, const slideio::MetadataFormat& mt)
{
    switch (mt)
    {
    case slideio::MetadataFormat::None:
        os << "None";
        break;
    case slideio::MetadataFormat::Unknown:
        os << "Unknown";
        break;
    case slideio::MetadataFormat::Text:
        os << "TEXT";
        break;
    case slideio::MetadataFormat::XML:
        os << "XML";
        break;
    case slideio::MetadataFormat::JSON:
        os << "JSON";
        break;
    }
    return os;
