...
namespace slideio
{
    ...
    public:
        ...
        public:
            ...
            const std::string& getMetadata() const override { return m_metadata; }
    ...
    public:
        ...
        FIMULTIBITMAP* getFIHandle() const { return m_hFile; }
        FREE_IMAGE_FORMAT getFIFormat() const { return m_fiFormat; }
        const std::string& getFilePath() const { return m_filePath; }
        int getNumTiffDirectories() const { return (int)m_tiffDirectories.size(); }
