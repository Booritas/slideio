...
namespace slideio
{
    ...
    public:
        ...
        int getSubSamplingDx() const { return m_subSamplingDX; }
        void setSubSamplingDx(int subSamplingDx) { m_subSamplingDX = subSamplingDx; }
        int getSubSamplingDy() const { return m_subSamplingDY; }
        void setSubSamplingDy(int subSamplingDy) { m_subSamplingDY = subSamplingDy; }
        Codec getCodecFormat() const { return m_codecFormat; }
        void setCodecFormat(Codec codecFormat) { m_codecFormat = codecFormat; }
        float getCompressionRate() const { return m_compressionRate; }
        void setCompressionRate(float compressionRate) { m_compressionRate = compressionRate; }
