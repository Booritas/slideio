...
{
    EXPECT_THROW(ConverterParameters params(ImageFormat::SVS, Container::TIFF_CONTAINER, Compression::Uncompressed),
                 RuntimeError);
}

TEST(ConverterParametersTests, UnsupportedContainerThrows)
{
    EXPECT_THROW(ConverterParameters params(ImageFormat::SVS, Container::UNKNOWN_CONTAINER, Compression::Jpeg),
                 RuntimeError);
}
