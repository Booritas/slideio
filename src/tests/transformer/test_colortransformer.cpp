...
TEST(ColorTransfomation, colorspaces3channels)
{
    ...
    ColorSpaceItem items[] = {{ColorSpace::HSV, cv::COLOR_RGB2HSV}, {ColorSpace::HLS, cv::COLOR_RGB2HLS},
                              {ColorSpace::YUV, cv::COLOR_RGB2YUV}, {ColorSpace::YCbCr, cv::COLOR_RGB2YCrCb},
                              {ColorSpace::LUV, cv::COLOR_RGB2Luv}, {ColorSpace::LAB, cv::COLOR_RGB2Lab},
...
TEST(ColorTransfomation, selectiveChannels)
{
    ...
    ColorSpaceItem items[] = {{ColorSpace::HSV, cv::COLOR_RGB2HSV, 0},
...
TEST(ColorTransfomation, selective2Channels)
{
    ...
    ColorSpaceItem items[] = {{ColorSpace::HSV, cv::COLOR_RGB2HSV, 0, 1},
