...
{
    testBmp(TestTools::getTestImagePath("gdal", "img_2448x2448_3x8bit_SRC_RGB_ducks.bmp"),
            TestTools::getTestImagePath("gdal", "img_2448x2448_3x8bit_SRC_RGB_ducks.raw"), slideio::DataType::DT_Byte,
            3);
}

TEST(ImageTools, readBitmap8BitGrayscale)
{
    testBmp(TestTools::getTestImagePath("gdal", "img_2448x2448_1x8bit_SRC_GRAY_ducks.bmp"),
            TestTools::getTestImagePath("gdal", "img_2448x2448_1x8bit_SRC_GRAY_ducks.raw"), slideio::DataType::DT_Byte,
            1);
}
...
TEST(ImageTools, readBitmapInvalidFile)
{
    ...
    cv::Mat bmpRaster;
    EXPECT_THROW({ slideio::ImageTools::readBitmap("nonexistent.bmp", bmpRaster); }, slideio::RuntimeError);
}
...
TEST(ImageTools, readBitmapInvalidFormat)
{
    ...
    EXPECT_THROW({ slideio::ImageTools::readBitmap(pathPng, bmpRaster); }, slideio::RuntimeError);
}
